...
def qa_metrics(targets, predictions):
  """
  Computes exact match and f1 QA scores, expecting pre-normalized text. Targets is list of lists (multiple references).
  Example usage:
  ...
  qa_utils.qa_metrics(targets, predictions)
  """
